...
const Item = ({ item, sourceColumnId }) => {
    ...
    return (
        <div
            ref={drag}
            className={`p-[20px]  rounded-[15px] shadow-[0px_18px_40px_0px_rgba(112,144,176,0.12)] ${isDragging ? "bg-gray-300" : "bg-white"}`}
        ...
        >
            ...
            {item.image && item.image !== 'null' && (
                <div className="my-[20px] rounded-[15px] overflow-auto">
                    <Image src={item.image} alt="item" className="" unoptimized />
                </div>
            )}
