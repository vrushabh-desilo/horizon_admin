...
const Mobile_Menu = () => {
    ...
    return (
        <div>
            <Sidebar className='px-0' visible={visible} onHide={() => setVisible(false)} header={customHeader}>
                <div className='bg-[#fff]  overflow-auto h-[calc(100vh_-_106px)]'>

                    <div className='h-[calc(100vh_-_106px)] overflow-auto ps-[10px] py-[40px] flex flex-col justify-between'>
            ...
            <div onClick={() => setVisible(true)}>
                <svg className='h-[24px] w-[24px]' stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
